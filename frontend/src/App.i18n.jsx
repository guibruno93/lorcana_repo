        ...
        <div className="header-container">
          ...
          <div className="user-info">
            ...
            <span className="user-greeting desktop-only">
              {t('auth.greeting')}, <strong>{user.username || user.email}</strong>
            </span>
