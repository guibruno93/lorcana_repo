...
const { parseIntOr, normalizeCardName } = require('../utils/parsers');
 ...
 * Uses centralized normalization utility (accents, punctuation, dashes, etc.)
 * @param {string} name - Card name to normalize
 * @returns {string} Normalized name
 */
const normalizeName = normalizeCardName;
