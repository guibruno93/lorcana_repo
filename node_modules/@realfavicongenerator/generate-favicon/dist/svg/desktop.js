...
exports.combineLightAndDaskModeDesktopIcons = exports.cloneSvg = exports.createFilteredSvgIcon = exports.createDesktopSvgIcon = void 0;
...
const createDesktopSvgIcon = (masterIcon, settings, imageAdapter) => {
    ...
    if (!(0, desktop_1.hasDarkIcon)(settings) && settings.regularIconTransformation.type === helper_1.IconTransformationType.None) {
        return (0, exports.cloneSvg)(masterIcon.icon, imageAdapter);
    }
    ...
    settings.darkIconType !== 'specific')
        ...
        return (0, exports.createFilteredSvgIcon)(masterIcon.icon, imageAdapter, settings.regularIconTransformation, (0, desktop_1.hasDarkIcon)(settings) ? settings.darkIconTransformation : undefined);
    }
...
const createFilteredSvgIcon = (image, imageAdapter, lightSettings, darkSettings) => {
    const icon = (0, exports.cloneSvg)(image, imageAdapter);
...
const cloneSvg = (svg, imageAdapter) => {
    const svgString = svg.svg();
    return (0, _1.stringToSvg)(svgString, imageAdapter);
};
